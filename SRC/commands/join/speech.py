# print("entry file: \"C:/Users/YaMaou/Desktop/QAQ/00/Justaway/kira/src/commands/join/speech.py\"")
import threading
import queue
import io
import logging
...
class STT:
    ...
    def stop(self):
        ...
        logging.info(f"{self.transcription}")
...
try:
    ...
    while stt.is_listening:
        ...
        if len(last_transcription) > 0:
            print(last_transcription, flush=True)
