print("entry file: \"C:/Users/YaMaou/Desktop/QAQ/00/Justaway/kira/src/commands/join/speech2.py\"", flush=True)
...
print("import threading,  queue, io, logging", flush=True)

import pyaudio
import speech_recognition as sr

print("import pyaudio,  speech_recognition", flush=True)

import time
from faster_whisper import WhisperModel

print("import time,  faster_whisper", flush=True)

print("Speech recognition script started.", flush=True) 

class STT:
    """Real-time Speech to Text class using Faster WhisperModel and speech_recognition."""

    def __init__(self, model_size: str = "medium.en", device: str = "cpu", compute_type: str = "float32",
    ...
    def stop(self):
        ...
        logging.info(f"Transcription:/n {self.transcription}")
